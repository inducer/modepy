...
_PYTHON_TEMPLATE = """# GENERATED by modepy/contrib/weights-from-sommariva.py
# DO NOT EDIT
...
class SommarivaQuadrature(Quadrature):
...
def generate_sommariva_quadrature_rules(outfile, pointset="set_amr_square"):
...
if __name__ == "__main__":
    ...
    generate_sommariva_quadrature_rules(outfile=args.outfile)
